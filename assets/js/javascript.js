...
let imagesArray = [
  'https://res.cloudinary.com/siriusscaper/image/upload/earth/image1.jpg',
  'https://res.cloudinary.com/siriusscaper/image/upload/earth/image2.jpg',
  'https://res.cloudinary.com/siriusscaper/image/upload/earth/image3.jpg',
  'https://res.cloudinary.com/siriusscaper/image/upload/earth/image4.jpg',
  'https://res.cloudinary.com/siriusscaper/image/upload/earth/image5.jpg',
  'https://res.cloudinary.com/siriusscaper/image/upload/earth/image6.jpg',
  'https://res.cloudinary.com/siriusscaper/image/upload/earth/image7.jpg',
  'https://res.cloudinary.com/siriusscaper/image/upload/earth/image8.jpg',
  'https://res.cloudinary.com/siriusscaper/image/upload/earth/image9.jpg',
  'https://res.cloudinary.com/siriusscaper/image/upload/earth/image10.jpg',
  'https://res.cloudinary.com/siriusscaper/image/upload/earth/image11.jpg',
  'https://res.cloudinary.com/siriusscaper/image/upload/earth/image12.jpg',
  'https://res.cloudinary.com/siriusscaper/image/upload/earth/image13.jpg',
  'https://res.cloudinary.com/siriusscaper/image/upload/earth/image14.jpg',
  'https://res.cloudinary.com/siriusscaper/image/upload/earth/image15.jpg',
  'https://res.cloudinary.com/siriusscaper/image/upload/earth/image16.jpg',
  'https://res.cloudinary.com/siriusscaper/image/upload/earth/image17.jpg',
  'https://res.cloudinary.com/siriusscaper/image/upload/earth/image18.jpg',
  'https://res.cloudinary.com/siriusscaper/image/upload/earth/image19.jpg',
  'https://res.cloudinary.com/siriusscaper/image/upload/earth/image20.jpg',
  'https://res.cloudinary.com/siriusscaper/image/upload/earth/image21.jpg',
  'https://res.cloudinary.com/siriusscaper/image/upload/earth/image22.jpg',
  'https://res.cloudinary.com/siriusscaper/image/upload/earth/image23.jpg',
  'https://res.cloudinary.com/siriusscaper/image/upload/earth/image24.jpg',
  'https://res.cloudinary.com/siriusscaper/image/upload/earth/image25.jpg',
]
...
let randomizer = function(){
  let randomQuote = quotesArray.random(quotesArray.length)
  let randomImage = imagesArray.random(imagesArray.length)
  document.getElementById('quote-container').innerHTML = randomQuote.quote + '<p></p>' + randomQuote.author
  document.getElementById('bg-Image').style.backgroundImage = 'url(' + randomImage + ')'
};
...
const customTweet = () => {
  var quoteAndAuthor = document.getElementById('quote-container').innerHTML
